											...
											<div>
												...
												<div style="color:#000;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;padding: 0;">
													...
													<div style="font-size:18px;line-height:26px;margin: 24px 0 0 0;">
														<p style="margin: 0">
															You're receiving this email because your password was reset. If you did not reset your password please contact support using the email below. If you performed a password reset you can safely ignore this email.
														</p>
													</div>
												</div>
