...
<body class="clean-body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #FAFAFA;">
	...
	<table class="nl-container" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #FAFAFA;width: 100%" cellpadding="0" cellspacing="0">
		<tbody>
											...
											<div>
												...
												<div style="color:#000;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;padding: 0;">
													...
													<div style="font-size:18px;line-height:26px;margin: 24px 0 0 0;">
														<p style="margin: 0">Event: ##EVENT_TITLE##</p>
														<p style="margin: 0">Start: ##EVENT_START##</p>
														<p style="margin: 0">End: ##EVENT_END##</p>
														<p style="margin: 0">Location: ##EVENT_LOCATION##</p>
													</div>
													<div style="font-size:18px;line-height:26px;margin: 24px 0 0 0;">
														<p style="margin: 0">
															In case you need to cancel, we use this easy code so you don’t have to remember or type in yet another long password.
														</p>
										...
										<div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
											...
											<div class="button-container left">
												...
												<div style="color: #000; background-color: #fff; margin: 0; border-radius: 5px; -webkit-border-radius: 5px; -moz-border-radius: 5px; max-width: 100%; width: 100%; border-radius: 12px; border: 1px solid rgba(0,0,0,0.12); padding: 10px 0; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; text-align: center; mso-border-alt: none;">
													<span style="font-family:monospace, Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:16px;"><span style="font-size: 43px; line-height: 55px; letter-spacing: 20px; display: inline-block; margin-left: 20px">##REGISTRATION_CODE##</span></span>
												</div>
